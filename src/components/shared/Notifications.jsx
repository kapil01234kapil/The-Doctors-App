  ...
  const deleteSingleNotification = async (notificationId) => {
    try {
      const res = await axios.delete(
        "/api/notifications/deleteOneNotification",
        {
          data: { notificationId },
          withCredentials: true,
        }
        ...
        <div className="mb-6 space-y-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4d91ff] focus:border-transparent outline-none transition-all"
            />
            {searchTerm && (
              <button

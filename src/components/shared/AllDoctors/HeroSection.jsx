...
const HeroSection = () => {
  ...
  return (
    <section className="w-full min-h-screen mt-10 px-4 md:px-12 lg:px-20">
      {/* Hero Section */}
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 w-11/12 md:w-1/2 text-black flex flex-col justify-center items-center md:items-start px-4 md:px-12 lg:px-20 gap-6 text-center md:text-left">
          <h1 className="font-bold text-3xl lg:text-6xl leading-snug text-black drop-shadow-lg">
            Top Verified <span className="text-[#1195FF]">Doctors</span> Near You
          </h1>
        ...
        {/* Filter Section */}
        <div className="w-full flex justify-center mt-6 lg:absolute lg:bottom-0">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 w-11/12 max-w-6xl bg-blue-50 p-4 rounded-3xl shadow-lg relative lg:-translate-y-1/4">
            ...
            <div className="w-full lg:w-1/2 relative mb-3 lg:mb-0">
              <Input
                ...
                className="pl-10 bg-white rounded-full w-full"
              />
...
<div className="w-full lg:w-1/4 relative mb-3 lg:mb-0">
  ...
  >
    <SelectTrigger className="pl-10 bg-white rounded-full w-full">
    ...
    <SelectContent>
      ...
      <SelectItem value="agra">Agra</SelectItem>
            ...
            <div className="w-full lg:w-1/4">
              <Button
                className="bg-[#1195FF] hover:bg-[#0d7dd1] text-white w-full rounded-full"
                onClick={() => {}}
              >
                Search
              </Button>

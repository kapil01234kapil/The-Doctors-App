...
function CalendarDayButton({
  ...
  return (
    (<Button
     ...
     className={cn(
  // 🌟 Our fix: replace bg-primary with custom blue
  "data-[selected-single=true]:bg-[#4d91ff] data-[selected-single=true]:text-white " +
  "data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground " +
  "data-[range-start=true]:bg-[#4d91ff] data-[range-start=true]:text-white " +
  "data-[range-end=true]:bg-[#4d91ff] data-[range-end=true]:text-white " +
  "hover:bg-[#e0ecff] hover:text-[#1d4ed8] cursor-pointer transition-all duration-200 " +

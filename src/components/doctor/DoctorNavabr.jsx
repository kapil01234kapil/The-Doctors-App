  ...
  return (
    <div className="w-full h-16 bg-white shadow-md flex items-center px-4 sm:px-6 justify-between">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        {/* Notification Icon */}
        <div onClick={() => router.push("/doctor/notifications")} className="rounded-full bg-gray-50 w-8 h-8 flex items-center justify-center cursor-pointer">
        ...
        {/* Profile + Popover */}
         <Avatar className="w-8 h-8">
              ...
              <h1 className="text-sm sm:text-base">Doctor</h1>
        <Popover>
